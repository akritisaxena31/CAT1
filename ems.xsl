	...
	<xsl:template match="/">
		<html>
			...
			<body style="padding:0; margin:0">
				...
				<header style="text-align:center; background: #2F4F4F; color: #ffffff;padding:1rem 0 0 0">
                    <h1>Employee Management System</h1>
                    <div style="padding:0 0 1rem 0">
                        <a style="padding:1rem" href="#">Home</a>
                        <a style="padding:1rem" href="#">Our Projects</a>
                        <a style="padding:1rem" href="#">Employees</a>
                        <a style="padding:1rem" href="#">Contact Us</a>
                        <a style="padding:1rem" href="#">Help and Service</a>
                    </div>
                </header>
				<div align="center">
                    <h2>Employee Details</h2>
                    <table style="padding:1.5rem; border:2.5px solid black" >
